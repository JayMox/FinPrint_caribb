...
ruth's original data lists 6 sites, 4 in 2016 2 in 2017..  raw data files only have 2016.  worthwhile pulling 2017 data via noaa's curl script in here/data/raw
nb.: 2017 is missing in data portal grunt.noaa.gov

taxa spp code list.. potential lkup table
...
- needs attn to assingmnet of site zone, reef, & transect numbers
